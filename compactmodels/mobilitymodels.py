#mobility models with the following flags:
# MODmudop: phonon scattering with doping dependance
# MODmuac: lombardi model, acoustic phonon scattering
# MODmusr: lombardi model, surface roughness scattering
# MODmuc: Coulomb Scattering
# MODmurcs: remote Coulomb scattering for high-k dielectrics
